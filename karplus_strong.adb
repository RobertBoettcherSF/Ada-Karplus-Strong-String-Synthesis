...
package body Karplus_Strong is
   ...
   procedure Plucked_String (
      ...
      -- Calculate delay line length (L = Fs / Freq - 0.5 for the LPF phase delay)
      Exact_Delay : Sample_Type := (Sample_Rate / Frequency) - 0.5;
